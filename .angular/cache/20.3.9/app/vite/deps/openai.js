...
function debug(action, ...args) {
  if (typeof process !== "undefined" && process?.env?.["DEBUG"] === "true") {
    const modifiedArgs = args.map((arg) => {
      ...
      if (arg["headers"]) {
        const modifiedArg2 = __spreadProps(__spreadValues({}, arg), { headers: __spreadValues({}, arg["headers"]) });
...
var Messages = class extends APIResource {
  list(completionId, query = {}, options) {
    ...
    return this._client.getAPIList(`/chat/completions/${completionId}/messages`, ChatCompletionStoreMessagesPage, __spreadValues({ query }, options));
  }
};
...
var Completions = class extends APIResource {
  ...
  update(completionId, body, options) {
    return this._client.post(`/chat/completions/${completionId}`, __spreadValues({ body }, options));
  }
  list(query = {}, options) {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.getAPIList("/chat/completions", ChatCompletionsPage, __spreadValues({ query }, options));
  }
  /**
...
var Translations = class extends APIResource {
  create(body, options) {
    return this._client.post("/audio/translations", multipartFormRequestOptions(__spreadProps(__spreadValues({ body }, options), { __metadata: { model: body.model } })));
  }
};
...
var Assistants = class extends APIResource {
  ...
  create(body, options) {
    return this._client.post("/assistants", __spreadProps(__spreadValues({
      ...
      headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers)
    }));
  }
  /**
...
var ChatCompletionStream = class _ChatCompletionStream extends AbstractChatCompletionRunner {
  ...
  static createChatCompletion(client, params, options) {
    ...
    runner._run(() => runner._runChatCompletion(client, __spreadProps(__spreadValues({}, params), { stream: true }), __spreadProps(__spreadValues({}, options), { headers: __spreadProps(__spreadValues({}, options?.headers), { "X-Stainless-Helper-Method": "stream" }) })));
    return runner;
  }
  async _createChatCompletion(client, params, options) {
  ...
  [(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest2() {
    ...
    if (!snapshot) {
      snapshot = __classPrivateFieldSet5(this, _ChatCompletionStream_currentChatCompletionSnapshot, __spreadProps(__spreadValues({}, rest), {
        choices: []
      }), "f");
    } else {
    ...
    for (const _f of chunk.choices) {
      ...
      if (!delta)
        continue;
      const _c2 = delta, { content, refusal, function_call, role, tool_calls } = _c2, rest2 = __objRest(_c2, ["content", "refusal", "function_call", "role", "tool_calls"]);
      assertIsEmpty(rest2);
      ...
      if (tool_calls) {
        ...
        for (const _d2 of tool_calls) {
          const _e = _d2, { index: index2, id, type, function: fn } = _e, rest3 = __objRest(_e, ["index", "id", "type", "function"]);
...
${str(snapshot)}`);
      ...
      return __spreadProps(__spreadValues({}, choiceRest), {
        message: __spreadProps(__spreadValues({}, messageRest), { content, role, refusal: message.refusal ?? null }),
        finish_reason,
        index,
        logprobs
      });
...
var TranscriptionSessions = class extends APIResource {
   ...
   */
  create(body, options) {
    return this._client.post("/realtime/transcription_sessions", __spreadProps(__spreadValues({
      body
    }, options), {
      headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers)
    }));
...
var Content = class extends APIResource {
  ...
  retrieve(containerId, fileId, options) {
    return this._client.get(`/containers/${containerId}/files/${fileId}/content`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "application/binary" }, options?.headers),
      __binaryResponse: true
    }));
  }
};
...
var Files = class extends APIResource {
  ...
  create(containerId, body, options) {
    return this._client.post(`/containers/${containerId}/files`, multipartFormRequestOptions(__spreadValues({ body }, options)));
  }
  /**
  ...
  list(containerId, query = {}, options) {
    ...
    return this._client.getAPIList(`/containers/${containerId}/files`, FileListResponsesPage, __spreadValues({
      query
    }, options));
  }
  /**
  ...
  del(containerId, fileId, options) {
    return this._client.delete(`/containers/${containerId}/files/${fileId}`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "*/*" }, options?.headers)
    }));
  }
};
...
var Containers = class extends APIResource {
   ...
   */
  create(body, options) {
    return this._client.post("/containers", __spreadValues({ body }, options));
  }
  /**
   * Retrieve Container
   */
  ...
  list(query = {}, options) {
    ...
    return this._client.getAPIList("/containers", ContainerListResponsesPage, __spreadValues({ query }, options));
  }
  /**
   * Delete Container
   */
  del(containerId, options) {
    return this._client.delete(`/containers/${containerId}`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "*/*" }, options?.headers)
    }));
  }
};
...
var Embeddings = class extends APIResource {
  ...
  create(body, options) {
    ...
    const response = this._client.post("/embeddings", __spreadValues({
...
var OutputItems = class extends APIResource {
  ...
  list(evalId, runId, query = {}, options) {
    ...
    return this._client.getAPIList(`/evals/${evalId}/runs/${runId}/output_items`, OutputItemListResponsesPage, __spreadValues({ query }, options));
  }
};
...
var Runs2 = class extends APIResource {
  ...
  create(evalId, body, options) {
    return this._client.post(`/evals/${evalId}/runs`, __spreadValues({ body }, options));
  }
  /**
  ...
  list(evalId, query = {}, options) {
    ...
    return this._client.getAPIList(`/evals/${evalId}/runs`, RunListResponsesPage, __spreadValues({ query }, options));
  }
  /**
   * Delete an eval run.
   */
...
var Evals = class extends APIResource {
   ...
   */
  create(body, options) {
    return this._client.post("/evals", __spreadValues({ body }, options));
  }
  /**
  ...
  update(evalId, body, options) {
    return this._client.post(`/evals/${evalId}`, __spreadValues({ body }, options));
  }
  list(query = {}, options) {
    if (isRequestOptions(query)) {
      return this.list({}, query);
    }
    return this._client.getAPIList("/evals", EvalListResponsesPage, __spreadValues({ query }, options));
  }
  /**
...
var Graders = class extends APIResource {
   ...
   */
  run(body, options) {
    return this._client.post("/fine_tuning/alpha/graders/run", __spreadValues({ body }, options));
  }
  /**
   * Validate a grader.
   *
  ...
  validate(body, options) {
    return this._client.post("/fine_tuning/alpha/graders/validate", __spreadValues({ body }, options));
  }
};
...
var Permissions = class extends APIResource {
  ...
  create(fineTunedModelCheckpoint, body, options) {
    return this._client.getAPIList(`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, PermissionCreateResponsesPage, __spreadValues({ body, method: "post" }, options));
  }
  retrieve(fineTunedModelCheckpoint, query = {}, options) {
    if (isRequestOptions(query)) {
      return this.retrieve(fineTunedModelCheckpoint, {}, query);
    }
    return this._client.get(`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, __spreadValues({
      query
    }, options));
  }
  /**
    ...
    return __spreadProps(__spreadValues({}, response), {
      ...
      output: response.output.map((item) => {
        ...
        if (item.type === "message") {
          return __spreadProps(__spreadValues({}, item), {
            content: item.content.map((content) => __spreadProps(__spreadValues({}, content), {
              parsed: null
            }))
          });
        } else {
    ...
    if (item.type === "message") {
      const content = item.content.map((content2) => {
        if (content2.type === "output_text") {
          return __spreadProps(__spreadValues({}, content2), {
...
function parseToolCall2(params, toolCall) {
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, toolCall), toolCall), {
...
var InputItems = class extends APIResource {
  list(responseId, query = {}, options) {
    ...
    return this._client.getAPIList(`/responses/${responseId}/input_items`, ResponseItemsPage, __spreadValues({
      query
    }, options));
  }
};
...
var ResponseStream = class _ResponseStream extends EventStream {
  ...
  static createResponse(client, params, options) {
    ...
    runner._run(() => runner._createOrRetrieveResponse(client, params, __spreadProps(__spreadValues({}, options), {
      headers: __spreadProps(__spreadValues({}, options?.headers), { "X-Stainless-Helper-Method": "stream" })
    })));
    return runner;
  }
  async _createOrRetrieveResponse(client, params, options) {
    ...
    if ("response_id" in params) {
      stream = await client.responses.retrieve(params.response_id, { stream: true }, __spreadProps(__spreadValues({}, options), { signal: this.controller.signal, stream: true }));
      starting_after = params.starting_after ?? null;
    } else {
      stream = await client.responses.create(__spreadProps(__spreadValues({}, params), { stream: true }), __spreadProps(__spreadValues({}, options), { signal: this.controller.signal }));
    }
    this._connected();
    for await (const event of stream) {
    ...
    switch (event.type) {
      case "response.output_text.delta": {
        ...
        if (output.type === "message") {
          ...
          maybeEmit("response.output_text.delta", __spreadProps(__spreadValues({}, event), {
      ...
      case "response.function_call_arguments.delta": {
        ...
        if (output.type === "function_call") {
          maybeEmit("response.function_call_arguments.delta", __spreadProps(__spreadValues({}, event), {
...
var Responses = class extends APIResource {
  ...
  create(body, options) {
    return this._client.post("/responses", __spreadProps(__spreadValues({ body }, options), { stream: body.stream ?? false }))._thenUnwrap((rsp) => {
  ...
  retrieve(responseId, query = {}, options) {
    return this._client.get(`/responses/${responseId}`, __spreadProps(__spreadValues({
      query
    }, options), {
  ...
  del(responseId, options) {
    return this._client.delete(`/responses/${responseId}`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "*/*" }, options?.headers)
    }));
  }
  parse(body, options) {
  ...
  cancel(responseId, options) {
    return this._client.post(`/responses/${responseId}/cancel`, __spreadProps(__spreadValues({}, options), {
      headers: __spreadValues({ Accept: "*/*" }, options?.headers)
    }));
  }
};
...
var Files3 = class extends APIResource {
  ...
  update(vectorStoreId, fileId, body, options) {
    return this._client.post(`/vector_stores/${vectorStoreId}/files/${fileId}`, __spreadProps(__spreadValues({
      body
    }, options), {
      headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers)
    }));
  ...
  content(vectorStoreId, fileId, options) {
    return this._client.getAPIList(`/vector_stores/${vectorStoreId}/files/${fileId}/content`, FileContentResponsesPage, __spreadProps(__spreadValues({}, options), { headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers) }));
  }
};
...
var FileBatches = class extends APIResource {
  ...
  listFiles(vectorStoreId, batchId, query = {}, options) {
    ...
    return this._client.getAPIList(`/vector_stores/${vectorStoreId}/file_batches/${batchId}/files`, VectorStoreFilesPage, __spreadProps(__spreadValues({ query }, options), { headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers) }));
  }
  /**
...
var VectorStores = class extends APIResource {
  ...
  search(vectorStoreId, body, options) {
    return this._client.getAPIList(`/vector_stores/${vectorStoreId}/search`, VectorStoreSearchResponsesPage, __spreadProps(__spreadValues({
      body,
      method: "post"
    }, options), {
      headers: __spreadValues({ "OpenAI-Beta": "assistants=v2" }, options?.headers)
